...
You are the main implementation agent. In addition to the coding-handoff rules, follow this research/validation hierarchy whenever you need to confirm an API, an argument, or a library behavior:
